...
makeManager = function makeManager() {
  ...
  maybeDone = dvl.group(function (requestBundle) {
    var i, j, len, len1, ref, request;

    for (i = 0, len = requestBundle.length; i < len; i++) {
      request = requestBundle[i];
    ...
    for (j = 0, len1 = requestBundle.length; j < len1; j++) {
      request = requestBundle[j];
      request.res.value((ref = request.resVal) != null ? ref : null);
      request.status = '';
  ...
  getData = function getData(request, query, err, resVal) {
  ...
  makeRequest = function makeRequest(request) {
    var _query, oldAjax, oldProcessResponce, processResponce, requestCount, responceProcessed;

    if (indexOf.call(request.requestBundle, request) < 0) {
    ...
    if (_query != null) {
      ...
      processResponce = function processResponce(err, data) {
        if (this === blockDummy) {
  ...
  inputChange = function inputChange() {
    var i, j, len, len1, makeRequestLater, newRequestBundle, q;
    makeRequestLater = [];
    newRequestBundle = [];
    ...
    for (j = 0, len1 = makeRequestLater.length; j < len1; j++) {
      q = makeRequestLater[j];
      makeRequest(q);
    }
  };
  ...
  addHoock = function addHoock(query, ret, requestCount) {
    if (worker) {
...
_async = function async(_ref) {
  var query = _ref.query,
      invalidOnLoad = _ref.invalidOnLoad,
...
_async.outstanding = outstanding;
nextGroupId = 0;

_async.getGroupId = function () {
  var id;
  id = nextGroupId;
  nextGroupId++;
  return id;
...
_async.requester = {
  ajax: function ajax(query, complete) {
    var abort, ajax, data;
    ...
    ajax = jQuery.ajax({
      ...
      success: function success(resVal) {
        if (query.fn) {
  ...
  cacheWrap: function cacheWrap() {
    var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _requester = _ref2.requester,
        max = _ref2.max,
        timeout = _ref2.timeout,
        keyFn = _ref2.keyFn;

    var cache, count, trim;

    if (!_requester) {
      throw new Error('it does not make sense to not have a requester');
    }

    if (typeof _requester !== 'function') {
      throw new Error('requester must be a function');
    }
    ...
    cache = {};
    count = 0;
    keyFn || (keyFn = function keyFn(_ref3) {
      var url = _ref3.url,
          data = _ref3.data,
          method = _ref3.method,
          dataType = _ref3.dataType,
          contentType = _ref3.contentType,
          processData = _ref3.processData;
      return [url, utilModule.strObj(data), method, dataType, contentType, processData].join('@@');
    });

    trim = function trim() {
      var cutoff, d, m, newCache, oldestQuery, oldestTime, q, results, tout;
      tout = timeout.value();
    ...
    return {
      ...
      requester: function requester(query, complete) {
        ...
        if (!c) {
          ...
          count++;
          trim();
          c.ajax = _requester(query, function (err, resVal) {
...
},{"./core":3,"./util":11}],2:[function(require,module,exports){
"use strict";

// Generated by CoffeeScript 2.4.1
var bind, bindSingle, class_concat, def_data_fn, dvl, id_class_spliter;
dvl = require('./core'); // dvl.bind # --------------------------------------------------
...
bind = function bind(_ref) {
  var parent = _ref.parent,
      ...
      transitionExit = _ref.transitionExit;
  var attrList, i, k, len, listen, nodeType, onList, out, part, parts, propertyList, staticClass, staticId, styleList, v;
  ...
  for (i = 0, len = parts.length; i < len; i++) {
    ...
    switch (part[0]) {
      ...
      default:
        throw "not currently supported in 'self' (".concat(part, ")");
    }
  }
  ...
  dvl.register({
    ...
    change: [out],
    fn: function fn() {
      var _data, _join, _parent, _transition, _transitionExit, a, add1, add2, addO, e, enter, ex, force, j, l, len1, len2, len3, m, postTrans, preTrans, s, t;
      ...
      if (_data) {
        ...
        _transitionExit = transitionExit.value(); // prep

        enter = [];
        preTrans = [];
        postTrans = [];

        add1 = function add1(fn, v) {
        ...
        for (l = 0, len2 = preTrans.length; l < len2; l++) {
          a = preTrans[l];
          s[a.fn](a.a1, a.a2);
        }
        ...
        for (m = 0, len3 = postTrans.length; m < len3; m++) {
          a = postTrans[m];
          t[a.fn](a.a1, a.a2);
        }
...
bindSingle = function bindSingle(_ref2) {
  ...
  var attrList, i, k, len, listen, nodeType, onList, part, parts, propertyList, staticClass, staticId, styleList, v;
...
dvl = function dvl(value) {
  return new DVLVar(value);
};

dvl.version = '1.5.0';
dvl._variables = variables = [];
dvl._workers = workers = []; // Available attributes / functions
// dvl._variables
// dvl._workers
// dvl.acc
// dvl.apply
...
default_compare = function default_compare(a, b) {
  return a === b;
};
...
function () {
  ...
  _createClass(DVLConst, [{
    key: "toString",
    value: function toString() {
      var tag;
      tag = this.n ? this.n + ':' : '';
      return "[".concat(this.tag).concat(this.v, "]");
    }
  }, {
    key: "value",
    ...
    value: function name() {
      ...
      if (arguments.length === 0) {
        return (ref = this.n) != null ? ref : '<anon_const>';
      } else {
        this.n = arguments[0];
        return this;
      }
    ...
    key: "applyValid",
    value: function applyValid(fn) {
      return dvl.applyValid(this, fn);
    }
  }, {
    key: "applyAlways",
    value: function applyAlways(fn) {
...
function () {
  ...
  _createClass(DVLVar, [{
    ...
    value: function toString() {
      var tag;
      tag = this.n ? this.n + ':' : '';
      return "[".concat(this.tag).concat(this.val, "]");
    }
  }, {
    key: "hasChanged",
    value: function hasChanged() {
    ...
    value: function value(val) {
      ...
      if (arguments.length) {
        ...
        if (this.proj) {
          var _this$proj = this.proj;
          parent = _this$proj.parent;
          fnDown = _this$proj.fnDown;
          pv = parent.value();
    ...
    value: function set(val) {
      ...
      if (this.proj) {
        var _this$proj2 = this.proj;
        parent = _this$proj2.parent;
        fnUp = _this$proj2.fnUp;
    ...
    value: function discard() {
      if (this.listeners.length > 0) {
        throw "Cannot remove variable ".concat(this.id, " because it has listeners.");
      }

      if (this.changers.length > 0) {
        throw "Cannot remove variable ".concat(this.id, " because it has changers.");
      }
    ...
    value: function name() {
      ...
      if (arguments.length === 0) {
        return (ref = this.n) != null ? ref : '<anon>';
      } else {
        this.n = arguments[0];
        return this;
      }
...
/*#__PURE__*/
function () {
  function DVLWorker(name1, ctx1, fn1, listen1, change1) {
    _classCallCheck(this, DVLWorker);

    var hasPrev, len, len1, len2, len3, lvl, m, min, n, nextWorker, nwid, o, p, prevWorker, ref, ref1, ref2, ref3, ref4, v;
    this.name = name1;
    this.ctx = ctx1;
    this.fn = fn1;
    this.listen = listen1;
    ...
    this.level = workers.length; // place at the end

    workers.push(this); // Append listen and change to variables and dependency graph
    ...
    if (this.updates.length()) {
      min = 2e308;
      ref4 = this.updates.valueOf();

      for (nwid in ref4) {
        nextWorker = ref4[nwid];
  ...
  _createClass(DVLWorker, [{
    key: "addChange",
    value: function addChange() {
      var len, len1, m, n, nextWorker, ref, updatesChanged, uv, v;
      uv = uniqById(arguments);

      if (uv.length) {
        updatesChanged = false;

        for (m = 0, len = uv.length; m < len; m++) {
          v = uv[m];
          this.change.push(v);
          v.changers.push(this);
          ref = v.listeners;
    ...
    value: function addListen() {
      var changedSave, hasPrev, i, len, len1, len2, len3, m, n, o, p, prevWorker, ref, updatesChanged, uv, v;
      uv = uniqById(arguments);
      ...
      for (o = 0, len2 = uv.length; o < len2; o++) {
        v = uv[o];
      ...
      for (i = p = 0, len3 = uv.length; p < len3; i = ++p) {
        v = uv[i];
    ...
    key: "discard",
    value: function discard() {
      var len, len1, len2, len3, m, n, o, p, prevWorker, ref, ref1, ref2, ref3, v; // Find the register object
      ...
      sortGraph();
      this.change = this.listen = this.updates = null; // cause an error if we hit these
    }
  }]);
...
dvl.register = function (_ref) {
  var ctx = _ref.ctx,
      ...
      name = _ref.name,
      noRun = _ref.noRun;
  var c, changedSave, i, l, len, len1, len2, len3, len4, listenConst, m, n, o, p, q, v, worker;
  ...
  if (listen) {
    for (m = 0, len = listen.length; m < len; m++) {
      v = listen[m];
  ...
  change = uniqById(change).map(getBase); // Make function/context holder object
  ...
  if (!noRun) {
    ...
    for (i = n = 0, len1 = listen.length; n < len1; i = ++n) {
      l = listen[i];
      changedSave[i] = l.changed;
      l.changed = true;
    }

    for (o = 0, len2 = listenConst.length; o < len2; o++) {
      l = listenConst[o];
      l.changed = true;
    }
    ...
    for (i = p = 0, len3 = changedSave.length; p < len3; i = ++p) {
      c = changedSave[i];
      listen[i].changed = c;
    }

    for (q = 0, len4 = listenConst.length; q < len4; q++) {
      l = listenConst[q];
      l.changed = false;
    }
  }
...
/*#__PURE__*/
function () {
  function DVLBlock(name1, parent1) {
    _classCallCheck(this, DVLBlock);
  ...
  _createClass(DVLBlock, [{
    key: "addMemeber",
    value: function addMemeber(thing) {
      this.owns[thing.id] = thing;
      return this;
    }
  }, {
    key: "removeMemeber",
    value: function removeMemeber(thing) {
    ...
    key: "discard",
    value: function discard() {
      var d, len, m, ref, ref1;

      if ((ref = this.parent) != null) {
        ref.removeMemeber(this);
      }
...
dvl.group = function (fn) {
  return function () {
    ...
    if (dvl.notify === _init_notify) {
      ...
      dvl.notify = _init_notify;

      _init_notify.apply(dvl, captured_notifies);
    } else {
...
dvl.namespace = function () {
  var str = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'ns';
  nsId++;
  return str + nsId;
}; // filter out undefineds and nulls and constants also make unique


uniqById = function uniqById(vs, allowConst) {
  var len, m, res, seen, v;
  res = [];

  if (vs) {
    seen = {};

    for (m = 0, len = vs.length; m < len; m++) {
      v = vs[m];
...
dvl.sortGraph = sortGraph = function sortGraph() {
  var from = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

  var _sources, getInboundCount, i, ic, idPriorityQueue, inboundCount, isSource, j, len, level, m, nextWorker, nwid, prevWorker, ref, ref1, v, worker, workerListen, workerListenLength, workersLength; // L <- Empty list that will contain the sorted elements
  ...
  idPriorityQueue = new PriorityQueue('id'); // This can be precomputed

  getInboundCount = function getInboundCount(worker, from) {
    var count, len, len1, m, n, prevWorker, ref, ref1, seen, v;
    seen = {};
    count = 0;
    ref = worker.listen;
  ...
  inboundCount = {};
  _sources = []; // S <- Set of all nodes with no incoming edges
  ...
  while (idPriorityQueue.length()) {
    ...
    ref1 = worker.updates.valueOf();

    for (nwid in ref1) {
      nextWorker = ref1[nwid];
...
dvl.clearAll = function () {
  var len, len1, m, n, v, worker; // disolve the graph to make the garbage collection job as easy as possible

  for (m = 0, len = workers.length; m < len; m++) {
    worker = workers[m];
    worker.listen = worker.change = worker.updates = null;
  }

  for (n = 0, len1 = variables.length; n < len1; n++) {
    v = variables[n];
...
start_notify_collect = function start_notify_collect(listener) {
  toNotify = [];
  curCollectListener = listener;
  dvl.notify = collect_notify;
};

end_notify_collect = function end_notify_collect() {
  curCollectListener = null;
  dvl.notify = _init_notify; // ToDo: possible nested notify?

  dvl.notify.apply(null, toNotify);
  toNotify = null;
};

collect_notify = function collect_notify() {
  var len, m, v;
  ...
  for (m = 0, len = arguments.length; m < len; m++) {
    ...
    if (indexOf.call(curCollectListener.change, v) < 0) {
      throw new Error("changed unregistered object ".concat(v.id, " (collect)"));
    }
...
dvl.notify = _init_notify = function init_notify() {
  var changedInNotify, l, lastNotifyRun, len, len1, m, n, notifyChainReset, ref, v, visitedListener;
  lastNotifyRun = [];
  visitedListener = [];
  changedInNotify = [];
  curNotifyListener = null;

  notifyChainReset = function notifyChainReset() {
    var l, len, len1, m, n, v;
    curNotifyListener = null;
    dvl.notify = _init_notify;

    for (m = 0, len = changedInNotify.length; m < len; m++) {
      v = changedInNotify[m];
      v.resetChanged();
    } // reset visited


    for (n = 0, len1 = visitedListener.length; n < len1; n++) {
      l = visitedListener[n];
      l.visited = false;
    }
  };
  ...
  dvl.notify = function () {
    // within_notify
    var errorMessage, len2, len3, o, p, prevStr, ref1;

    if (!curNotifyListener) {
      throw new Error('bad stuff happened within a notify block');
    }

    for (o = 0, len2 = arguments.length; o < len2; o++) {
      v = arguments[o];
      ...
      if (indexOf.call(curNotifyListener.change, v) < 0) {
        prevStr = changedInNotify.map(function (v) {
          return v.id;
        }).join(';');
        errorMessage = "changed unregistered object ".concat(v.id, " within worker ").concat(curNotifyListener.id, " [prev:").concat(prevStr, "]");
        notifyChainReset();
...
dvl.apply = dvl.applyValid = function () {
  var allowNull, args, _fn, invalid, out, update;
  ...
  switch (arguments.length) {
    case 1:
      ...
      _fn = _arguments$.fn;
      invalid = _arguments$.invalid;
      allowNull = _arguments$.allowNull;
      update = _arguments$.update;
    ...
    case 3:
      ...
      args = _arguments6[0];
      var _arguments6$ = _arguments6[1];
      invalid = _arguments6$.invalid;
      allowNull = _arguments6$.allowNull;
      update = _arguments6$.update;
      _fn = _arguments6[2];
      break;
  ...
  dvl.register({
    name: 'apply_fn',
    listen: args.concat([_fn, invalid]),
    change: out,
    fn: function fn() {
      var a, f, len, m, nulls, r, send, v;
      f = _fn.value();
...
dvl.applyAlways = function () {
  var args, _fn2, out, update;

  switch (arguments.length) {
    case 1:
      var _arguments$2 = arguments[0];
      args = _arguments$2.args;
      _fn2 = _arguments$2.fn;
      update = _arguments$2.update;
  ...
  _fn2 = dvl.wrap(_fn2 || dvl.identity);
  ...
  dvl.register({
    name: 'apply_fn',
    listen: args.concat([_fn2]),
    change: out,
    fn: function fn() {
      var a, f, len, m, r, send;
      f = _fn2.value();
...
op_to_lift = {
  ...
  'iff': function iff(cond, truthy, falsy) {
    if (cond) {
      return truthy;
    } else {
      return falsy;
  ...
  'iffEq': function iffEq(lhs, rhs, truthy, falsy) {
    if (lhs === rhs) {
      return truthy;
    } else {
      return falsy;
  ...
  'iffLt': function iffLt(lhs, rhs, truthy, falsy) {
    if (lhs < rhs) {
      return truthy;
    } else {
      return falsy;
...
module.exports = dvl;
},{"../lib/lift":12,"./dataStructure/priorityQueue":4,"./dataStructure/set":5,"./util":11}],4:[function(require,module,exports){
"use strict";
...
function () {
  ...
  _createClass(PriorityQueue, [{
    ...
    key: "moveDown_",
    value: function moveDown_(index) {
      var count, key, leftChildIndex, node, nodes, rightChildIndex, smallerChildIndex;
      nodes = this.nodes_;
      key = this.key;
      count = nodes.length; // Save the node being moved down.

      node = nodes[index]; // While the current node has a child.
    ...
    key: "moveUp_",
    value: function moveUp_(index) {
      var key, node, nodes, parentIndex;
      nodes = this.nodes_;
      key = this.key;
      node = nodes[index]; // While the node being moved up is not at the root.
...
var _require = require('./bind');

bind = _require.bind;
bindSingle = _require.bindSingle;
// HTML # --------------------------------------------------
htmlModule = {}; // Capture the size of something in HTML

htmlModule.resizer = function (_ref) {
...
htmlModule.out = function (_ref2) {
  var selector = _ref2.selector,
      data = _ref2.data,
      fn = _ref2.fn,
      format = _ref2.format,
      invalid = _ref2.invalid,
      hideInvalid = _ref2.hideInvalid,
      attr = _ref2.attr,
      style = _ref2.style,
      text = _ref2.text;
  var out, updateHtml, what;
  ...
  if (attr) {
    ...
    out = function out(selector, string) {
...
htmlModule.list = function (_ref3) {
  var parent = _ref3.parent,
      data = _ref3.data,
      label = _ref3.label,
      link = _ref3.link,
      listClass = _ref3["class"],
  ...
  if (listClass != null) {
    ...
    listClass = dvl.applyAlways([selection, selections, highlight], function (_selection, _selections, _highlight) {
      return function (d) {
        ...
        if (_selections) {
          classParts.push(indexOf.call(_selections, d) >= 0 ? 'is_selections' : 'isnt_selections');
        }
  ...
  onClick = dvl.group(function (val, i) {
    ...
    linkVal = typeof (base = link.value()) === "function" ? base(val) : void 0;
    selection.value(val);
  ...
  myOnEnter = function myOnEnter(val) {
  ...
  myOnLeave = function myOnLeave(val) {
  ...
  dvl.register({
    ...
    fn: function fn() {
      ...
      addIcons = function addIcons(el, position) {
...
htmlModule.combobox = function (_ref4) {
  var parent = _ref4.parent,
      classStr = _ref4.classStr,
      data = _ref4.data,
      label = _ref4.label,
      selectionLabel = _ref4.selectionLabel,
      link = _ref4.link,
      listClass = _ref4["class"],
      id = _ref4.id,
      selection = _ref4.selection,
      selections = _ref4.selections,
      onSelect = _ref4.onSelect,
      onEnter = _ref4.onEnter,
      onLeave = _ref4.onLeave,
      menuAnchor = _ref4.menuAnchor,
      title = _ref4.title,
      icons = _ref4.icons,
      keepOnClick = _ref4.keepOnClick,
      disabled = _ref4.disabled,
      highlight = _ref4.highlight,
      focus = _ref4.focus;
  var divCont, filterCharacters, filteredData, menuCont, menuOpen, myOnSelect, namespace, updateScroll, valueOut;
  ...
  filteredData = dvl.def(); // Make sure that the selection is always within the data
  ...
  dvl.register({
    ...
    fn: function fn() {
      ...
      if (!_data || indexOf.call(_data, _selection) < 0) {
  ...
  dvl.register({
    ...
    fn: function fn() {
      ...
      _filteredData = _data.filter(function (datum) {
        var ref;
        return ((ref = String(_label(datum))) != null ? ref.toLowerCase().indexOf(_filterPhrase) : void 0) > -1;
      });
  ...
  divCont = bindSingle({
    ...
    attr: {
      "class": dvl.applyAlways({
        ...
        fn: function fn(_classStr, _menuOpen, _disabled) {
  ...
  updateScroll = function updateScroll() {
    var _data, _menuCont, _selection, element, pos, selectionIndex;
  ...
  valueOut.on('keydown', function () {
    var _data, _filterCharacters, _label, _selection, keyCode, selectionIndex;
    ...
    keyCode = d3.event.which || d3.event.keyCode; // Do not block tab keys
    ...
    // Capture
    var _data, _filterCharacters, _label, keyCode;
  ...
  dvl.register({
    ...
    fn: function fn() {
      ...
      setTimeout(function () {
        // We need this defer because it seems that the blur of another element is called synchronously
        if (_focus) {
          _valueOut.focus();
        } else {
          _valueOut.blur();
  ...
  myOnSelect = function myOnSelect(text, i) {
    if (!keepOnClick) {
      menuOpen.value(false);
    }
  ...
  d3.select(window).on("click.".concat(namespace), function () {
    var ref, target, togMenuOpen;
    ...
    if (divCont.node() === target || $(divCont.node()).find(target).length) {
      ...
      if (togMenuOpen || valueOut.node().id !== ((ref = document.activeElement) != null ? ref.id : void 0)) {
        menuOpen.value(!menuOpen.value());
      }
    } else {
      menuOpen.value(false);
    }
  }, true).on("blur.".concat(namespace // Use capture
  ), function () {
    menuOpen.value(false);
  });
  dvl.register({
...
htmlModule.dropdown = function (_ref5) {
  var parent = _ref5.parent,
      classStr = _ref5.classStr,
      data = _ref5.data,
      label = _ref5.label,
      selectionLabel = _ref5.selectionLabel,
      link = _ref5.link,
      listClass = _ref5["class"],
      id = _ref5.id,
      ...
      menuAnchor = _ref5.menuAnchor,
      title = _ref5.title,
      icons = _ref5.icons,
      keepOnClick = _ref5.keepOnClick,
      disabled = _ref5.disabled,
      highlight = _ref5.highlight,
      focus = _ref5.focus;
  var divCont, menuCont, menuOpen, myOnSelect, namespace, updateScroll, valueOut;
  ...
  link = dvl.wrap(link);
  disabled = dvl.wrap(disabled != null ? disabled : false);
  focus = dvl.wrapVar(focus); // Make sure that the selection is always within the data
  ...
  updateScroll = function updateScroll() {
    var _data, _menuCont, _selection, element, selectionIndex;
  ...
  valueOut.on('keydown', function () {
    var _data, _label, _selection, keyCode, selectionIndex;
    ...
    // Capture
    var _data, _label, datum, j, keyCode, len, userChar;
...
htmlModule.select = function (_ref6) {
  var parent = _ref6.parent,
      data = _ref6.data,
      classStr = _ref6.classStr,
      value = _ref6.value,
      label = _ref6.label,
  ...
  selection = dvl.wrapVar(selection, 'selection');
  _focus2 = dvl.wrapVar(_focus2 != null ? _focus2 : false);
  ...
  dvl.register({
    ...
    fn: function fn() {
      var _data, _selectEl, _selection, idx;
  ...
  dvl.register({
    listen: [selectEl, _focus2],
    fn: function fn() {
      var _focus, _selectEl;

      _selectEl = selectEl.value();
      _focus = _focus2.value();
...
(function () {
  ...
  addPxIfNeeded = function addPxIfNeeded(str) {
    if (str == null) {
      return null;
    }
  ...
  htmlModule.table = function (_ref7) {
    var parent = _ref7.parent,
        headParent = _ref7.headParent,
        data = _ref7.data,
        sort = _ref7.sort,
        classStr = _ref7.classStr,
        rowClass = _ref7.rowClass,
        rowLimit = _ref7.rowLimit,
        columns = _ref7.columns,
        onRow = _ref7.on;
    var bodyCol, c, comp, compare, compareList, compareMap, headTable, headerCol, j, len, ref, sortDir, sortOn, sortOnIndicator, table;
    table = bindSingle({
      parent: parent,
      self: 'table',
      attr: {
    ...
    sortOnIndicator = dvl.wrapVar((ref = sort.onIndicator) != null ? ref : sortOn);
    headerCol = [];
    bodyCol = [];
    compareMap = {};
    ...
    dvl.register({
      ...
      change: [compare],
      fn: function fn() {
        var _sortDir, _sortOn, cmp, oldCmp, ref1;

        _sortOn = sortOn.value();
        _sortDir = sortDir.value();

        if (_sortOn != null) {
          cmp = (ref1 = compareMap[_sortOn]) != null ? ref1.value() : void 0;
    ...
    htmlModule.table.header({
      ...
      onClick: function onClick(id) {
        var column, compareModes, l, len1;
        column = null;
  ...
  htmlModule.table.header = function (_ref8) {
    var parent = _ref8.parent,
        columns = _ref8.columns,
        onClick = _ref8.onClick;
    var c, enterLiner, enterTh, headerRow, j, len, listen, nc, newColumns, ref, sel, thead;
    ...
    for (j = 0, len = columns.length; j < len; j++) {
      ...
      newColumns.push(nc = {
        ...
        visible: dvl.wrap((ref = c.visible) != null ? ref : true),
    ...
    dvl.register({
      ...
      listen: listen,
      fn: function fn() {
        var _indicator, i, ind, l, len1, visibleChanged, w;

        for (i = l = 0, len1 = columns.length; l < len1; i = ++l) {
          c = columns[i];
          sel = headerRow.select("th:nth-child(".concat(i + 1, ")"));
          ...
          if (c.visible.value()) {
            ...
            if (onClick.hasChanged() || visibleChanged) {
              sel.on('click', function (d) {
                var base;
                return typeof (base = onClick.value()) === "function" ? base(d.id) : void 0;
              });
            }
  ...
  htmlModule.table.body = function (_ref9) {
    var parent = _ref9.parent,
        data = _ref9.data,
        compare = _ref9.compare,
        rowClass = _ref9.rowClass,
        classStr = _ref9.classStr,
        rowLimit = _ref9.rowLimit,
        columns = _ref9.columns,
        onRow = _ref9.on;
    var c, change, j, k, l, len, len1, listen, nc, newColumns, onRowNew, ref, ref1, render, tbody, v;
    ...
    for (j = 0, len = columns.length; j < len; j++) {
      ...
      change.push(nc.selection = dvl().name("".concat(c.id, "_selection")));
    }
    ...
    dvl.register({
      ...
      fn: function fn() {
        ...
        for (i = l = 0, len1 = columns.length; l < len1; i = ++l) {
          c = columns[i];
          sel = tbody.selectAll("td:nth-child(".concat(i + 1, ")")).data(dataSorted);
  ...
  return htmlModule.table.render = {
    text: function text(selection, value) {
      dvl.register({
    ...
    html: function html(selection, value) {
      dvl.register({
        listen: [selection, value],
        fn: function fn() {
          var _selection, _value;
    ...
    img: function img(selection, value) {
      return bind({
        parent: selection,
        self: 'img',
        attr: {
    ...
    imgDiv: function imgDiv(selection, value) {
      return bind({
        parent: selection,
        self: 'div',
        attr: {
    ...
    sparkline: function sparkline(_ref12) {
...
},{"./bind":2,"./core":3,"d3":44}],7:[function(require,module,exports){
"use strict";

// Generated by CoffeeScript 2.4.1
var bind, bindSingle, dvl;
dvl = require('./core');
...
module.exports = dvl;
},{"./async":1,"./bind":2,"./core":3,"./html":6,"./misc":8,"./snap":9,"./svg":10,"./util":11}],8:[function(require,module,exports){
"use strict";

// Generated by CoffeeScript 2.4.1
var d3, dvl, miscModule;
d3 = require('d3');
dvl = require('./core'); // misc # --------------------------------------------------
...
miscModule.delay = function (data) {
...
},{"./core":3,"d3":44}],9:[function(require,module,exports){
"use strict";
...
module.exports = function (_ref) {
  ...
  updateSnap = function updateSnap() {
    var a, d, dist, ds, i, j, len, minDatum, minDist, minIdx, v;
    ds = data.value();
    a = acc.value();
    v = value.value();
    ...
    if (ds && a && v) {
      ...
      if (trim.value() && ds.length !== 0 && (v < a(ds[0]) || a(ds[ds.length - 1]) < v)) {
        ...
        if (ds) {
          for (i = j = 0, len = ds.length; j < len; i = ++j) {
            d = ds[i];
            dist = Math.abs(a(d) - v);
...
// Generated by CoffeeScript 2.4.1
var bind, bindSingle, clipId, dvl, svgModule;
dvl = require('./core');
...
svgModule.clipPath = function (_ref) {
  var parent = _ref.parent,
      x = _ref.x,
      y = _ref.y,
      width = _ref.width,
  ...
  return "url(#".concat(myId, ")");
};

module.exports = svgModule;
},{"./bind":2,"./core":3}],11:[function(require,module,exports){
"use strict";
...
utilModule = {
  ...
  strObj: function strObj(obj) {
    var i, k, keys, len, str, type;
  ...
  isEqual: function isEqual(a, b, cmp) {
    var aKeys, atype, bKeys, btype, c, i, k, len;
...
},{"d3-array":13,"d3-axis":14,"d3-brush":15,"d3-chord":16,"d3-collection":17,"d3-color":18,"d3-contour":19,"d3-dispatch":20,"d3-drag":21,"d3-dsv":22,"d3-ease":23,"d3-fetch":24,"d3-force":25,"d3-format":26,"d3-geo":27,"d3-hierarchy":28,"d3-interpolate":29,"d3-path":30,"d3-polygon":31,"d3-quadtree":32,"d3-random":33,"d3-scale":35,"d3-scale-chromatic":34,"d3-selection":36,"d3-shape":37,"d3-time":39,"d3-time-format":38,"d3-timer":40,"d3-transition":41,"d3-voronoi":42,"d3-zoom":43}]},{},[7]);
